...
class Permission {
	 ...
	 * 
	 * @param string $groupName				Nome do grupo, igual como definido nas arrays que
	 * 										armazenam as listas de grupos do site.
	 */
	 ...
	 * 
	 * @param array $groupTags				Array contendo todos os grupos existentes no sistema
	 * 										de permissões.
	 */
	 ...
	 * 
	 * @param array $resourceTags			Array contendo todos os recursos existentes no sistema
	 * 										de permissões.
	 */
