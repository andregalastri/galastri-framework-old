...
class Database extends Composition {
	 ...
	 * 				 ->submit();
	 * 
	 * @param int|string $field			Armazena o nome da referência ou o número da ocorrência
	 * 									da querystring.
	 * 
	 * @param mixed $value				Valor real a qual o argumento de referência se refere e
	 * 									que será o dado real usado na consulta.
	 */
	 ...
	 * 									que armazena o resultado que se quer recuperar. Quando não
	 * 									informado, utiliza o rótulo padrão.
	 */
	 ...
	 * 
	 * @param string $property			Informa o nome da propriedade que representa qual o método
