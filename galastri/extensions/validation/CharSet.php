 ...
 * 							O padrão é min(1).
 * 
 * caseUpper, caseLower		Permite definir se as letras permitidas devem ser maíusculas, minísculas
 * caseAll					ou se isto é indiferente para o teste. O padrão é caseAll().
 * 
